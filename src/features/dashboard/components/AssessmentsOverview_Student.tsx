...
const AssessmentsOverview_Student = () => {
          ...
          >
            {assessments.map((item, index) => (
              <tr key={index}>
                ...
                <td>{item.class}</td>
                <td>{item.status}</td>
                <td className="py-4 text-center">{item.attempts}</td>
                  ...
                  <button className="rounded-lg p-1.5 transition-colors hover:bg-[#F3F4FF] cursor-pointer">
                    {item.action === "view" && (
                      <Eye
                        size={16}
                        onClick={() =>
                          navigate("/teacher/dashboard/review-assessment")
                        }
                      />
                    )}
                    {item.action === "edit" && (
                      <Edit2
                        size={16}
                        onClick={() =>
                          navigate("/student/attend-assessment/id")
                        }
                      />
                    )}
...
export default AssessmentsOverview_Student;
