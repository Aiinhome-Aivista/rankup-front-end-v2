...
const Login = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-[#A1AEF2] font-sans">
      ...
      {/* Login Card */}
      <div className="absolute left-1/2 top-1/2 z-10 min-h-125 w-full max-w-md -translate-x-1/2 -translate-y-1/2 px-4 lg:max-w-md xl:max-w-lg 2xl:max-w-xl">
        <div className="flex flex-col justify-center rounded-4xl border-3 border-[#FFFFFF40] bg-white/10 p-8 shadow-2xl backdrop-blur-lg md:p-10">
          <div className="flex flex-col items-center text-center text-white">
            ...
            <div className="flex justify-center gap-10 mb-6">
              <button
                type="button"
                className="flex items-center justify-center w-13 h-13 rounded-xl bg-[#FFFFFF80] hover:bg-white/20 transition-all duration-300 backdrop-blur-md shadow-lg shadow-[#00000033] group opacity-90"
              >
                <svg
            ...
            <div className="custom-scrollbar max-h-[50vh] w-full space-y-4 overflow-y-auto">
              <div className="relative">
                <input
                  ...
                  className={`w-full rounded-xl border border-[#D9D9D9]! bg-transparent px-5 py-3 text-white outline-none transition-all duration-300 placeholder-white! focus:border-white/50 focus:bg-white/10 ${isOtpSent ? "cursor-not-allowed opacity-50" : ""
                    }`}
                />
              </div>
              ...
              <button
                ...
                type="button"
                disabled={isLoading}
                className={`mt-2 flex w-full cursor-pointer transform items-center justify-center gap-2 rounded-xl bg-[#FBFBFB80] py-3 font-semibold text-indigo-900 shadow-lg transition-all duration-300 hover:bg-white hover:shadow-xl ${isLoading ? "cursor-not-allowed opacity-70" : ""
                  }`}
              >
                {isLoading ? (
                  <>
